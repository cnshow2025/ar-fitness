...
- 開始前站在畫面中央、雙腳併攏，App 依腳踝位置與腿長自動校正，在地板上畫出 3×3 九宮格（有透視感）。
...
- 畫面上方有平面 3×3 預告格，用數字 1～5 標出接下來 5 步的位置（1 就是下一步）。預告格是俯視方向：上排＝靠近手機（前）、下排＝遠離手機（後）、左右＝您的左右；旁邊 4 顆節拍燈隨拍子亮起，地板格線也會隨節拍閃動。
